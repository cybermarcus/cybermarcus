<h1 align="center">Привет, меня зовут <a href="https://t.me/marcus_vinicius_0" target="_blank">Павел</a> 
...
- Поработал над своими проектами (можно ознакомиться ниже)
- Сейчас предпочитаю развивать навыки через практический подход: брать нестандартные задачи, чтобы осваивать новые инструменты или методы решения. Так, для развертывания своего проекта с автоматизацией отправки отчета освоил базовую работу с Docker.
